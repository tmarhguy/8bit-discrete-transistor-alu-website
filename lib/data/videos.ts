...
export const featuredVideos: VideoItem[] = [
  {
    ...
    poster: '/media/images/hero/hero_system_photo.png',
    duration: '2:30',
    category: 'overview',
  },
  {
...
export const buildVideos: VideoItem[] = [
  {
    ...
    poster: '/media/images/process/timeline/process_timeline_01_mosfet_design.jpg',
    duration: '3:00',
    category: 'build',
  },
  {
  ...
  },
  {
    ...
    poster: '/media/images/design/kicad/nand_gate_poster.png',
    category: 'build',
  },
  {
    id: 'pcb-routing',
    ...
    poster: '/media/images/design/kicad/main_logic.png',
    category: 'build',
  },
];
